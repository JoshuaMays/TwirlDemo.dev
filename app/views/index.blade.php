...
<header class="masthead">
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="logo">Twirl Salon</div> 
      <!-- Controls -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav nav-justified">
          ...
          <li><a href="#section4">Stylists</a></li>
...
<div class="row">
  ...
  <div class="col-sm-3 pull-right">
      ...
      <address>
        ...
        <span id="map-input">
        118 Blue Star #2<br>
        San Antonio, TX 78204</span><br>
        P: (210) 781-4198
      </address>
    
      <address>
        <strong>Email Us</strong><br>
        <a href="mailto:#">salon@twirl.com</a>
      </address>          
  </div>
...
<div class="container">
    <div class="col-sm-8 col-sm-offset-2 text-center">
      ...
      <ul class="list-inline center-block">
        <li><a href="https://www.facebook.com/pages/Twirl-Salon/142372125818484"><i class="icon-facebook"></i></a></li>
        <li><a href="https://plus.google.com/112569048605073566968/"><i class="icon-googleplus"></i></a></li>
        <li><a href="http://www.pinterest.com/bluestararts/twirl-salon/"><i class="icon-pinterest"></i></a></li>
      </ul>
