...
<div class="modal fade" id="salonModal" tabindex="-1" role="dialog" aria-labelledby="salonModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-body">
            <div id="salonCarousel" class="carousel slide carousel-fit" data-ride="carousel" data-interval="60000" style="margin-top: 0px; height: 310px;">
                <!-- Indicators -->
                <ol class="carousel-indicators">
                    <li data-target="#salonCarousel" data-slide-to="0" class="active"></li>
                    <li data-target="#salonCarousel" data-slide-to="1" class=""></li>
                    <li data-target="#salonCarousel" data-slide-to="2" class=""></li>
                </ol>
                <!-- Wrapper for slides -->
